...
export default function SpotLightCollectionOneElement({spotlightDatum}:{spotlightDatum:Spotlight}) {
  return (
    <div className='w-[258px] h-[625px] p-[15px] bg-white dark:bg-[#3b3e47] relative my-[15px] mx-3 shadow-bx overflow-hidden after:absolute after:bottom-[26%] after:right-[-9px] after:w-[20px] after:h-[20px] after:rounded-full after:z-[1]
